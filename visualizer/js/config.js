...
function getLayerParams(type, layerId) {
    ...
    if (type === 'waves') {
        ...
        params[`textStartDelay_${layerId}`] = { cat: `text_${layerId}`, name: 'Intro Delay [s]', min: 0, max: 60, step: 1, value: 15, formula: '15', useFormula: false, desc: 'Seconds of visual ambiance before lyrics begin appearing after selecting a preset.' };
