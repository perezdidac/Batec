function createDefaultParams() {
    return {
        ...
        // WAVES
        waveCount: { cat: 'waves', name: 'Emanation Rings', min: 0, max: 50, step: 1, value: 0, formula: '0', useFormula: false, desc: 'Number of circular waves expanding from the center.' },
        ...
        // RAYS (HYPERSPACE)
        rayCount: { cat: 'rays', name: 'Laser Beams', min: 0, max: 200, step: 1, value: 0, formula: '0', useFormula: false, desc: 'Number of light rays emanating from the center point.' },
        ...
        imgOpacity: { cat: 'photos', name: 'Global Opacity', min: 0, max: 1, step: 0.01, value: 0.7, formula: '0.2 + (avg/255)*0.8', useFormula: false, desc: 'Transparency of the background media pool.' },
        imgGlitch: { cat: 'photos', name: 'Glitch Intensity', min: 0, max: 500, step: 1, value: 0, formula: '120 + bass', useFormula: false, desc: 'Randomized X/Y offset applied to the image based on music energy.' },
        ...
        particleWind: { cat: 'particles', name: 'Atmospheric Wind', min: -20, max: 20, step: 0.1, value: 2.0, formula: '2.0 + (trend * 10)', useFormula: true, desc: 'A global force that causes all particles to drift collectively. Best mapped to overall song energy.' },
        particleBreezeStrength: { cat: 'particles', name: 'Organic Breeze', min: 0, max: 1, step: 0.01, value: 0.5, formula: '0.5', useFormula: false, desc: 'The intensity of the collective rhythmic swaying of particles.' },
        ...
        opticsFocusPull: { cat: 'analog', name: 'Depth of Field', min: 0, max: 200, step: 1, value: 30, formula: '(1.0 - trend) * 50', useFormula: true, desc: 'Gaussian blur simulating camera bokeh. Blurry during quiet ambiance, snaps sharp during loud hits.' },
...
function createDefaultPreset(name = "New Preset") {
    return {
        ...
        settings: {
            ...
            textFontFamily: 'Lora', // Serif (Indie vibe)
            textDissolveStyle: 'ink', // 'fade' | 'ink'
            textFreeze: false,
